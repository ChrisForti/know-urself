  ...
  return (
    <div className={styles.nine}>
      ...
      <p>
        ...
        is something only you can do. I only offer theories. Perhaps your
        beautiful presence, the side of you that helps those without fortune,
        comes from your sensitivity. You want to beautify everything, so you’re
        sensitive to seeing beauty in everyone as a 9. You have the power to let
        people see it within themselves. You’re a visionary and want to create
        the world that you see in your mind’s eye. So you take action and help
        those you think can help you achieve aspects of it, number 9. As a
        sensitive person, you can be overly sensitive in your pursuit of
        perfection. This can not only hurt you, but others. Proceed with
        caution, 9. You need to take responsibility for any times when you react
        in an overly-sensitive manner. If you don’t step up and act with
        honesty, it could cause a problem. Instead of taking everything to heart
        and falling into a depressive episode, focus on the better parts of the
        ...
        and proceed. Be aware, your sensitivity can also make you impressionable
        and gullible. As a 9 who’s easily disappointed, these things could bring
        up emotions that aren’t healthy to have.
      </p>
      <h2>Impatience</h2>
      <p>
        Although you wish to beautify the world, you may have other goals too.
        And you’re idealistic about them, sometimes to an extent that’s
        unrealistic and impractical. Your goals may even extend past wanting to
        beautify the world, but instead wanting the world itself. Your
        selfishness can creep out and override your past generosity, number 9.
        You want what you want now and if you don’t get it you’ll fall into a
        mental state that’s undesirable. This impatience may even apply to your
        selfless actions, too. You want those receiving your generosity to get
        what they need at once. You need to learn to wait for things, and even
        people. Your impatience extends to people, too. Around the ones you
        don’t feel are worthy of your time. You’re tolerant to an extent, but
        need to learn to apply it to situations where you’re being arrogant
        around people you see as lesser, number 9.
      </p>
    </div>
  );
}
